...
public class AverageDirectionalIndex_
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		AdxEntry[] entries = AverageDirectionalIndex.calculate(candles, 14);

		Arrays.stream(entries).forEach(s -> System.out.println(s == null ? "null" : s.toString()));
	}

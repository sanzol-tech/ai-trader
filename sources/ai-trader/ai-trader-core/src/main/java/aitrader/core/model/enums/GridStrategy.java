...
public enum GridStrategy
{
	...
	SIGNAL("Signal", QuantityType.USD, 5.0, 0, null, null, PriceIncrType.GEOMETRIC, QtyIncrType.POSITION, 0.02, 1.0, null, null),
	SIMPLE("Simple", QuantityType.USD, 20.0, 0, null, null, PriceIncrType.GEOMETRIC, QtyIncrType.POSITION, 0.02, 1.0, 0.01, 0.02),
	BTC("Btc", QuantityType.BALANCE, 10.0, 4, null, null, PriceIncrType.GEOMETRIC, QtyIncrType.POSITION, 0.02, 1.0, 0.005, 0.02),
	ALTCOIN("Altcoin", QuantityType.USD, 5.0, 4, null, null, PriceIncrType.GEOMETRIC, QtyIncrType.POSITION, 0.04, 2.0, 0.005, 0.02),
	CLASSIC6("Classic 6", QuantityType.USD, 5.0, 6, null, null, PriceIncrType.GEOMETRIC, QtyIncrType.ORDER, 0.02, 1.4, 0.005, 0.02),
	CLASSIC8("Classic 8", QuantityType.USD, 5.0, 8, null, null, PriceIncrType.GEOMETRIC, QtyIncrType.ORDER, 0.02, 1.4, 0.005, 0.02),
	INCREMENTAL1("Incremental 1", QuantityType.USD, 5.0, 5, null, null, PriceIncrType.GEOMETRIC, QtyIncrType.POSITION, 0.005, 0.0, 0.01, 0.02),
	INCREMENTAL2("Incremental 2", QuantityType.USD, 5.0, 10, null, null, PriceIncrType.GEOMETRIC, QtyIncrType.POSITION, 0.005, 0.0, 0.01, 0.02);

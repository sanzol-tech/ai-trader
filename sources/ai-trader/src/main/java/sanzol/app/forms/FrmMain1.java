...
public class FrmMain1 extends JFrame implements PriceListener, SignalListener, BalanceListener
{
	...
	private void initComponents()
	{
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(FrmMain1.class.getResource("/resources/logo.png")));
		...
		listFavorites.setForeground((Color) null);
		listFavorites.setFont(new Font("Courier New", Font.PLAIN, 12));
		listFavorites.setBackground((Color) null);
		...
		listSignals.setForeground((Color) null);
		listSignals.setFont(new Font("Courier New", Font.PLAIN, 11));
		listSignals.setBackground((Color) null);
		...
		txtBalanceMinAvailable.setText("30.0");
		...
		pnlStatusBarLayout.setHorizontalGroup(
			pnlStatusBarLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, pnlStatusBarLayout.createSequentialGroup()
					.addContainerGap()
					.addComponent(txtError, GroupLayout.DEFAULT_SIZE, 598, Short.MAX_VALUE)
					.addGap(18)
	...
	private void pageload()
	{
		try
		{
			...
			btnLookFeel.setText(Styles.isNight ? CharConstants.MOON : CharConstants.MOON);
